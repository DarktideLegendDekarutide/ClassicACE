...
using ACE.Server.DotRecast.Detour.TileCache;
using ACE.Server.DotRecast.Detour.TileCache.Io.Compress;
using ACE.Server.DotRecast.Recast.Geom;
using ACE.Server.DotRecast.Recast.Toolset.Builder;
using ACE.Server.DotRecast.Recast.Toolset.Geom;
...
namespace ACE.Server.DotRecast.Recast.Toolset.Tools
{
    public class RcObstacleTool : IRcToolable
    {
        ...
        public NavMeshBuildResult Build(IInputGeomProvider geom, RcNavMeshBuildSettings setting, RcByteOrder order, bool cCompatibility)
        {
            ...
            // Generation params.
            var walkableRadius = (int)(float)Math.Ceiling(setting.agentRadius / setting.cellSize); // Reserve enough padding.
