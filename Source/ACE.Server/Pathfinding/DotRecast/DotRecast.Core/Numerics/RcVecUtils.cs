...
namespace ACE.Server.DotRecast.Core.Numerics
{
    public static class RcVecUtils
    {
        ...
        {
            return Extensions.FloatIsFinite(v.X) && Extensions.FloatIsFinite(v.Y) && Extensions.FloatIsFinite(v.Z);
        }
        ...
        {
            return Extensions.FloatIsFinite(v.X) && Extensions.FloatIsFinite(v.Z);
        }
