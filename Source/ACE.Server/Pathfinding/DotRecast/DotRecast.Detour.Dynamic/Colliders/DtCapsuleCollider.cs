...
namespace ACE.Server.DotRecast.Detour.Dynamic.Colliders
{
    public class DtCapsuleCollider : DtCollider
    {
        ...
        {
            RcFilledVolumeRasterization.RasterizeCapsule(hf, start, end, radius, area, (int)(float)Math.Floor(flagMergeThreshold / hf.ch), context);
        }
