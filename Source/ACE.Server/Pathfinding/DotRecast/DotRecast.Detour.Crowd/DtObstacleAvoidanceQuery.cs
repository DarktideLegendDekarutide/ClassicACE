     ...
     */
            ...
            float minPenalty, DtObstacleAvoidanceDebugData debug)
        {
            ...
            for (int i = 0; i < m_ncircles; ++i)
            {
                ...
                // Side
                side += Extensions.MathClamp(Math.Min(cir.dp.Dot2D(vab) * 0.5f + 0.5f, cir.np.Dot2D(vab) * 2), 0.0f, 1.0f);
                nside++;
            ...
            DtObstacleAvoidanceDebugData debug)
        {
            ...
            int nd = Extensions.MathClamp(ndivs, 1, DT_MAX_PATTERN_DIVS);
            int nr = Extensions.MathClamp(nrings, 1, DT_MAX_PATTERN_RINGS);
