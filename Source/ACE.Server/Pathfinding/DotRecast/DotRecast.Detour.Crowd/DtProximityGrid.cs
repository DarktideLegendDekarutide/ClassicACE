...
namespace ACE.Server.DotRecast.Detour.Crowd
{
    public class DtProximityGrid
    {
        ...
        {
            int iminx = (int)(float)Math.Floor(minx * _invCellSize);
            int iminy = (int)(float)Math.Floor(miny * _invCellSize);
            int imaxx = (int)(float)Math.Floor(maxx * _invCellSize);
            int imaxy = (int)(float)Math.Floor(maxy * _invCellSize);
